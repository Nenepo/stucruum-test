...
function Upload() {
  ...
  return (
    isMobile && (<section className="bg-[#EFEFEF] dark:bg-[#161616] px-4 pb-4">
      ...
      <div className="w-full h-[320px] rounded-2xl relative flex items-center flex-col justify-between bg-white dark:bg-[#000] px-[44px] pt-[16px] pb-[50px]">
        <div>
          <div className="flex items-center justify-center">
            {isDarkMode ? <img src={lightUserImg} alt="profile" className="w-[24px] h-[24px]" /> : <img src={darkUserImg} alt="profile" />}
        ...
        <img src={closeIcon} alt="close" className="absolute right-6 top-7" />
      </div>
      ...
      <div className="w-full h-[282px] rounded-2xl mt-[24px] bg-white dark:bg-[#000] p-4">
        ...
        <p className="font-thin text-[14px] leading-[20px] tracking-tight  text-[#808080] dark:text-[#A5A5A5] w-[368px] mt-6">Submit your works for review for our <span className="font-medium">STUCRUUM</span> project. Remember to tick ☑ the ‘ARTRUUM’ checkbox if you’re also submitting for our <span className="font-medium">ARTRUUM</span> project.</p>
